...
O banco de dados `starwars` vai ser empregado para este conjunto de atividades. `starwars` contém características de 87 personagens da franquia criada por George Lucas. Para saber mais sobre esses dados, utilize:
