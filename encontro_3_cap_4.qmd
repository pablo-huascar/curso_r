...
Descubra qual companhia (`carrier`) tem, em média, os maiores atrasos na decolagem (`dep_delay`)  
...
Descubra de qual aeroporto partem (`origin`) os voos com maiores atrasos na decolagem (`dep_delay`)
