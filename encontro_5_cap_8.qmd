...
read_csv("ID,Nome Completo,Idade,Sexo,Estado Civil
...
-   Decimais separados por vírgula: valores separados por `;`
    -   2,4;5,7;6,7
...
-   `comment = "#"`: eliminar todas as linhas que começam, por exemplo, col_names "\#"
