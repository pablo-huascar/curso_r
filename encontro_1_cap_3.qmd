...
## [Vamos começar!]{style="font-size: 130pt; line-height: 0.7; text-align: left; display: flex; align-items: center; justify-content: center;"} {transition="slide-in fade-out" transition-speed="slow"}
...
## As operaões podem ser realizadas entre objetos
...
## Uso dos comentários: Demarcar seções do no código {.smaller .scrollable} 
::: panel-tabset
### Código
```{r}
