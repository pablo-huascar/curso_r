...
## As operaões podem ser realizadas entre vetores
...
- Sabendo que o Índice de Massa Corpórea (IMC) é obtido dividindo o peso (em kg) pela altura ao quadrado (em metros), crei um objeto imc com os valores do IMC de cada caso. 

##  Exercícios 4 - respostas
